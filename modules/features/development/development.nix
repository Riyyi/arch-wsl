{ self, ... }:
{
  flake.homeModules.development =
    ...
    in
    {
      ...
      preferences.zsh.initExtra = lib.optionalString (config.preferences.distro == "ubuntu") ''
        [ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
        [ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion
      '';

      preferences.zsh.profileExtra = lib.optionalString (config.preferences.distro == "ubuntu") ''
